...
#	team_id       = forms.CharField(max_length=20,help_text='(Your team name will be your username,so please choose a unique team name)' )
	...
	class Meta(BaseUserForm.Meta):
		fields =('team_name','password','password_again','team_leader','team_leader_mobilenumber','team_leader_email',
'member_2','mobilenumber_2','email_2','member_3','mobilenumber_3','email_3','member_4','mobilenumber_4','email_4','member_5','mobilenumber_5'
,'email_5','college_name','want_accommodation','accomodation_for_boys','accomodation_for_girls')#,'captcha')
